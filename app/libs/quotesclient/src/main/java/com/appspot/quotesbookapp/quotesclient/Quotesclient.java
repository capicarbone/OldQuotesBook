...
public class Quotesclient extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the quotesclient library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GcmClient {
    ...
    public class Save extends QuotesclientRequest<com.appspot.quotesbookapp.quotesclient.model.ApiMessagesQuotesCollection> {
       ...
       */
      protected Save() {
        super(Quotesclient.this, "POST", REST_PATH, null, com.appspot.quotesbookapp.quotesclient.model.ApiMessagesQuotesCollection.class);
      }
  ...
  public class Quotes {
    ...
    /**
     * Create a request for the method "quotes.search".
     *
     * This request holds the parameters needed by the quotesclient server.  After setting any optional
     * parameters, call the {@link Search#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.quotesbookapp.quotesclient.model.ApiMessagesSearchRequestMsg}
     * @return the request
     */
    public Search search(com.appspot.quotesbookapp.quotesclient.model.ApiMessagesSearchRequestMsg content) throws java.io.IOException {
      Search result = new Search(content);
      initialize(result);
      return result;
    }

    public class Search extends QuotesclientRequest<com.appspot.quotesbookapp.quotesclient.model.ApiMessagesSearchResultMsg> {

      private static final String REST_PATH = "quotes/search";
       ...
       * @since 1.13
       */
      protected Search(com.appspot.quotesbookapp.quotesclient.model.ApiMessagesSearchRequestMsg content) {
        super(Quotesclient.this, "POST", REST_PATH, content, com.appspot.quotesbookapp.quotesclient.model.ApiMessagesSearchResultMsg.class);
      }
    ...
    public class Some extends QuotesclientRequest<com.appspot.quotesbookapp.quotesclient.model.ApiMessagesQuotesCollection> {
      ...
      @com.google.api.client.util.Key("only_dayquotes")
      private java.lang.Boolean onlyDayquotes;

      /**

       */
      public java.lang.Boolean getOnlyDayquotes() {
        return onlyDayquotes;
      }

      public Some setOnlyDayquotes(java.lang.Boolean onlyDayquotes) {
        this.onlyDayquotes = onlyDayquotes;
        return this;
      }
