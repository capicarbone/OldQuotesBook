...
/**
 * Created by capi on 03/04/15.
 */
public class RoundedImageAutoFitView extends ImageAutoFitView {
...
// original ImageView.
    ...
    public RoundedImageAutoFitView(Context context) {
        super(context);
    }
    public RoundedImageAutoFitView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public RoundedImageAutoFitView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RoundedImageAutoFitView, defStyle, 0);
        final int index = a.getInt(R.styleable.RoundedImageAutoFitView_android_scaleType, -1);
        if (index >= 0) {
            setScaleType(sScaleTypeArray[index]);
        }
        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageAutoFitView_sriv_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageAutoFitView_sriv_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageAutoFitView_sriv_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageAutoFitView_sriv_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.RoundedImageAutoFitView_sriv_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }
        mBorderColor = a
                .getColorStateList(R.styleable.RoundedImageAutoFitView_sriv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }
        isOval = a.getBoolean(R.styleable.RoundedImageAutoFitView_sriv_oval, false);
        a.recycle();
        updateDrawable();
    }
    @Override
